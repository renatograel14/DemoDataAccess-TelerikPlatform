...
(function() {
    var provider = app.data.dataAccessDemo = new Everlive({
            offlineStorage: true,
            appId: 'twv895txwi9d0vbq',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'dataAccessDemo_access_token',
...
// START_CUSTOM_CODE_dataAccessDemo
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_dataAccessDemo